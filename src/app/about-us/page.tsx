...
const linkClassName =
  "text-red-600 hover:text-red-800 underline decoration-dotted underline-offset-4 transition-colors duration-200";
...
function page() {
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row my-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center p-4">
          <p className="text-base text-gray-700 md:text-lg">
            At the City Computer Science Society, we{" "}
            <a href={"/internships"} className={linkClassName}>
              connect
            </a>{" "}
            students and industry experts <br />
            We{" "}
            <a
            ...
            experience and opportunities for our participants <br />
            We{" "}
            <a href={"/"} className={linkClassName}>
              believe
            </a>{" "}
            in importance of having a strong community of like-minded people at
            City <br />
            We{" "}
            <a
            ...
            closely with other Computer Science societies and companies in the
            industry to be a bridge for students who want to discover more
          </p>
        </div>
      </div>
      ...
      <Section
        heading="Our program"
        gridClasses="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto px-4"
      >
        <Program
          icon={FaLaptopCode}
          title="Workshops"
      ...
      <SponsorForm colour={"white"} />

      {/*Our events section*/}
      <Section
        heading={"Our events"}
        gridClasses={
          "md:grid-cols-3 md:max-w-screen-xl md:gap-6 md:mx-auto md:my-16 px-4" +
          "lg:max-w-none lg:grid-cols-4 lg:mx-auto lg:my-16 lg:gap-10 lg:text-base px-4"
        }
      >
      ...
      <Section
        ...
        gridClasses={
          "md:grid-cols-4 md:max-w-screen-xl md:mx-auto md:my-16 md:gap-10 md:text-base text-base justify-center "
        }
        initialGrid={2}
      >
