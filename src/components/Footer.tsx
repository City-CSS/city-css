export default function Footer() {
  return (
    <footer className="relative border-t border-gray-100 lg:pt-32 pb-8 dark:border-gray-800 lg:px-0 md:px-0 px-10">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] top-[calc(50%-15rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#1955d2] to-[#1955d2] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
